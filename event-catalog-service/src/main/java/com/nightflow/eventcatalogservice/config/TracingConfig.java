...
public class TracingConfig {
    ...
    @Value("${spring.application.name:event-catalog-service}")
    ...
    // Handlers for ObservationRegistry
    @Bean
    ...
    public FilterRegistrationBean<ServerHttpObservationFilter> observationFilter(ObservationRegistry registry) {
        // Handlers are automatically registered to the registry by Spring Boot if they are beans?
        // Or do we need to manually register them?
        // ObservationRegistryConfigurer usually does it.
        // Let's assume Spring Boot picks up Handler beans.
